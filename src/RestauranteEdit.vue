<template>
	<div id="container restaurante-edit" style="width: 50%; margin: 0px auto">		
		<div class="row">
...
export default {
	...
	mounted(){
		...
		axios.get('http://localhost/restaurantes-api.php/restaurante/' + this.id)
		.then((res) => {
	...
	methods: {
		guardarRestaurante(){
			...
			axios.post('http://localhost/restaurantes-api.php/update-restaurante/' + id, params)
			.then((res) => {
